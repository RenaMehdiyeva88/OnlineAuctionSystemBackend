...
namespace OnlineAuctionSystem.Presentation.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost("register")]
        public async Task<ActionResult<Application.Users.DTOs.AuthResponse>> Register(RegisterUserRequest request, CancellationToken cancellationToken)
        {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<Application.Users.DTOs.AuthResponse>> Login(LoginRequest request, CancellationToken cancellationToken)
        {
        ...
        [HttpPost("refresh")]
        public async Task<ActionResult<Application.Users.DTOs.AuthResponse>> Refresh(RefreshTokenRequest request, CancellationToken cancellationToken)
        {
